...
- **v0.1.4** (Current): Production-ready with SIMD-accelerated mathematical utilities
...
- **v0.1.4**: Production-ready release with comprehensive statistical functionality
