...
impl OptimizedFFT {
    ...
    pub fn suggest_optimal_size(&self, requestedsize: usize) -> usize {
        ...
        let next_pow2 = requestedsize.next_power_of_two();
